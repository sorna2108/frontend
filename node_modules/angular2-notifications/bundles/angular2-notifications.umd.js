(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('@angular/core'),require('@angular/platform-browser'),require('@angular/common'),exports, require('@angular/animations'), require('@angular/core'), require('@angular/platform-browser'), require('rxjs'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('angular2-notifications', ['@angular/core','@angular/platform-browser','@angular/common','exports', '@angular/animations', '@angular/core', '@angular/platform-browser', 'rxjs', '@angular/common'], factory) :
    (global = global || self, factory(global.ng.core,global.ng.platformBrowser,global.ng.common,global['angular2-notifications'] = {}, global.ng.animations, global.ng.core, global.ng.platformBrowser, global.rxjs, global.ng.common));
}(this, (function (ɵngcc0,ɵngcc1,ɵngcc2,exports, animations, core, platformBrowser, rxjs, common) { 
...
function NotificationComponent_div_2_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function NotificationComponent_div_2_div_4_Template_div_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r18); var ctx_r17 = ɵngcc0.ɵɵnextContext(2); return ctx_r17.onClickIcon($event); });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
...
var _c1 = function (a0, a1, a2, a3, a4, a5, a6, a7) { return { "alert": a0, "error": a1, "warn": a2, "success": a3, "info": a4, "bare": a5, "rtl-mode": a6, "has-icon": a7 }; };
...
'use strict';
    ...
    var NotificationsService = /** @class */ (function () {
        ...
        NotificationsService = __decorate([ __param(0, core.Inject('options'))
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(SimpleNotificationsModule, { declarations: [SimpleNotificationsComponent, NotificationComponent], imports: [ɵngcc2.CommonModule], exports: [SimpleNotificationsComponent] }); })();
